...
const Section1Contact = () => {
  return (
    <div className='all-section1-Contact'>
      ...
      <h1> Contact Me</h1> 
      <br />
      <p>  - This form was created to collect your information and send it to my personal database (MongoDB Atlas). If you prefer, you can also reach out to me directly via my personal WhatsApp or LinkedIn.</p>
