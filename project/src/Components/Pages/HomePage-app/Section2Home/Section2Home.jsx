...
<p className='card-exb-bc-secondCard-text-secondP'> I worked on the development of fullstack applications collaborating with an agile team composed of junior, mid-level and senior developers, Scrum Master and other professionals.</p>
    </div>
  </div>
</div>
<div className='arrow'><FaLongArrowAltRight /></div>
